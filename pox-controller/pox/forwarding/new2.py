...
flow2out = of.ofp_action_output (port = )

flow2dstIP = of.ofp_action_nw_addr.set_dst(IPAddr("10.0.0.4"))

flow2srcMAC = of.ofp_action_dl_addr.set_src(EthAddr("00:00:00:00:00:08"))

flow2dstMAC = of.ofp_action_dl_addr.set_dst(EthAddr("00:00:00:00:00:04"))
...
flow3msg.match.nw_src = IPAddr("10.0.0.7")

# ACTIONS---------------------------------

flow3out = of.ofp_action_output (port = 2)

flow3srcIP = of.ofp_action_nw_addr.set_src(IPAddr("10.0.0.1"))

flow3srcMAC = of.ofp_action_dl_addr.set_src(EthAddr("00:00:00:00:00:07"))
     ...
     if a.hwtype == arp.HW_TYPE_ETHERNET:
       ...
       if a.opcode == arp.REQUEST:
         ...
         if str(a.protodst)=="10.0.0.4":
           ...
           r.hwsrc = EthAddr("00:00:00:00:00:08")
